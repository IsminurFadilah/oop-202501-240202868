...
public class MainCart {
    public static void main(String[] args) throws InvalidQuantityException, InvalidPriceException {
        ...
        System.out.println("Setelah menghapus " + p1.getCode() + " " + p1.getName() + " dari keranjang:");
